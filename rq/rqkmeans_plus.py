...
def parse_args():
    ...
    parser.add_argument("--pretrained_codebook_path", type=str, default="../data/Arts_Crafts_and_Sewing/Arts_Crafts_and_Sewing.codebooks_constrained.npz",
                        help="Path to RQ-KMeans npz file")
    
    parser.add_argument('--num_emb_list', type=int, nargs='+', default=[256,256,256,256])
    parser.add_argument('--e_dim', type=int, default=896, help='Must match input dim for RQ-KMeans+')
    ...
    parser.add_argument("--ckpt_dir", type=str, default="./Encoder/rq_kmeans")
